...
DATASETS_DIR="$USER_HOME/ORB_SLAM3/Datasets"
ARCHIVE_DIR="$DATASETS_DIR/archive"
BASE_FOLDER="realsense_d435i"
CALIBRATION_DIR="$USER_HOME/ORB_SLAM3/Examples/Calibration"
PROCESS_SCRIPT_DIR="$CALIBRATION_DIR/python_scripts"
RECORDER_EXEC="$CALIBRATION_DIR/recorder_realsense_D435i_v2"
